...
- (BOOL)loadWithPlayerParams:(NSDictionary *)additionalPlayerParams {
  ...
  if (![playerParams objectForKey:@"playerVars"]) {
    [playerParams setValue:[[NSMutableDictionary alloc] init] forKey:@"playerVars"];
      
  }
//    NSMutableDictionary *dict = [playerParams objectForKey:@"playerVars"];
//    [dict setValue:@"1" forKey:@"playsinline"];
